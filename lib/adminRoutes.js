...
FlowRouter.route("/admin/auto-dj-playlists", {
  name: "adminAutoDJPlaylists",
  action() {
    document.title = "Admin Auto DJ Playlists";
    BlazeLayout.render("HomeLayout", {main: "adminAutoDJPlaylists"})
  }
})